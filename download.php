...
// echo "Looking for: " . $_GET['file'] . "<br>";
// echo "File exists: " . (file_exists($_GET['file']) ? "YES" : "NO") . "<br>";
// exit; // Remove this line after testing

// fal mod: correct file are on main directory, so we redirecting user to the main page downloader
//	header('Location: ../download.php?file=./'.$_GET['file']);
//	exit;
// code bellow aren't executed, cause we've been redirect user
